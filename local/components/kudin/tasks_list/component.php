...
$res = CIBlockElement::GetList(array(), 
                               ...
                               false, 
                               false, 
                               array("ID", "PROPERTY_CALC_COMMENTS", "PROPERTY_STATUS", 
                                     "IBLOCK_ID", 'PROPERTY_TRACKING'));
...
$arResult['PERCENTS_TIME'] = intval(($arResult['TRACKING_TASK_TIME'] / $arResult['ALL_TASK_TIME']) * 100);
